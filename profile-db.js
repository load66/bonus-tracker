...
(function(){
  ...
  const DB=[
    ...
    {id:'chase-total-checking-personal',bank:'Chase',product:'Chase Total Checking',type:'personal checking',kind:'direct-deposit',status:'saved-flexible-coupon',needs:['coupon-specific bonus and direct deposit amount may vary'],baseline:{reqDays:90},critical:['reqDays'],note:'Personal Chase Total Checking direct deposit offer. Coupon bonus and required DD amount can vary; do not compare amount/count as hard conflicts.'},
    {id:'chase-business-complete-checking',bank:'Chase',product:'Business Complete Checking',type:'business checking',kind:'deposit-hold-transactions',status:'saved',needs:[],baseline:{bonus:500,reqMoney:10000,reqDays:90,fundedDays:30,holdDays:60,count:5},critical:['bonus','reqMoney','reqDays','fundedDays','holdDays','count'],note:'New money, 60-day balance hold, and 5 qualifying transactions. Close timing must come from the current offer T&C; eligibility lookback wording is not a current-account hold rule.'},
