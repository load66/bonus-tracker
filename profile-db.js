...
(function(){
  ...
  const DB=[
    ...
    {id:'chase-business-complete-checking',bank:'Chase',product:'Business Complete Checking',type:'business checking',kind:'deposit-hold-transactions',status:'saved',needs:[],baseline:{bonus:500,reqMoney:10000,reqDays:90,fundedDays:30,holdDays:60,count:5},critical:['bonus','reqMoney','reqDays','fundedDays','holdDays','count'],note:'New money, 60-day balance hold, 5 qualifying transactions; close on day 91 or later from opening after bonus posts.'},
