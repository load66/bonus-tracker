/* ✅ Version 3.3.89 update: Analyzer Training Library, user learning rules, Verified Apply Mode, and adaptive analyzer learning. */
...
const BANK_IDENTITY_VERSION='3.3.89';
...
function normalizeLifecycleEntry(e){
  ...
  // v3.3.89: closed remains actual only. Planned close is stored separately by the close flow.
