...
const BANK_IDENTITY_VERSION='3.3.77';
...
/* v3.3.77 mobile focus rule: do not call R() inside text input oninput handlers inside modal; iOS Safari drops keyboard when modal redraws. */
